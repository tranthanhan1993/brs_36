...
<div class="freework">
    <article class="col-lg-3 col-md-3 col-sm-3 sm3">
        {{ Html::image('user/img/page1_pic6.jpg','a picture', array('class' => 'home_img')) }}
        ...
        <ul class="list2">
            ...
            <li><a href="#">{{ trans('user.address') }}: Thanh Khue, Da Nang</a></li>
                ...
                <!-- FAVORITE BOOKS -->
        <h3 class="favor_h3">{{ Html::image('user/img/book.png','a picture', array('class' => 'imgleft')) }}{{ trans('master.favorite_book') }}</h3>
        ...
        <div class="list_book">
            ...
            <a href="#">
                ...
                <!-- END FAVORITE BOOKS -->
                <!-- LIST FOLLOW -->
        <h3 class="fo_h3">{{ Html::image('user/img/fl.png','a picture', array('class' => 'imgleft')) }}{{ trans('master.list_follow') }}</h3>
        <div class="list_follow" >
            <div class="tbfollow" >
                <table>
                    ...
                    <tr>
                        <td>{{ Html::image('user/img/page1_pic6.jpg','a picture', array('class' => 'imgfollow')) }}</td>
    ...
    <div class="timeline">
        ...
        <div class="timecontent" >
            <table>
                ...
                <tr>
                    <td>{{ Html::image('user/img/like3.png','a picture', array('class' => 'hlike')) }}</td>
                    <td>You likes hong dao's </td>
                    <td>Đừng cố gắng kéo một sợi dây {{ Html::image('user/img/page3_pic1.jpg','a picture', array('class' => 'hbook')) }}</td>
                    <td>{{ Html::image('user/img/option.png','a picture', array('class' => 'hoption')) }}</td>
                </tr>
            </table>
        </div>
    </div>
