...
<head>
    ...
    {!! Html::style('bower/datatables-responsive/css/responsive.dataTables.css') !!}
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i>{{ trans('user.edit_profile') }}</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="#"><i class="fa fa-sign-out fa-fw"></i> {{ trans('user.logout') }}</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">{{ trans('author.list_author') }}</a>
                                </li>
                                <li>
                                    <a href="#">{{ trans('author.add_author') }}</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">{{ trans('book_request.list_request') }}</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
