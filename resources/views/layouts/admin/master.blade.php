...
<html>
    ...
    <body class="theme-cyan">
                    ...
                    <div class="info-container">
                        ...
                        <div class="btn-group user-helper-dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="#"><i class="material-icons">person</i>{{ trans('label.profile') }}</a>
                                </li>
                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">
                                    ...
                                    <span>{{ trans('label.nav_menu.category') }}</span>
                                </a>
                                <ul class="ml-menu">
                                    <li>
                                        <a href="#">
                                            <i class="material-icons">add</i>
                                            <span>{{ trans('category.head.create') }}</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i class="material-icons">list</i>
                                            <span>{{ trans('category.head.index') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle">
                                ...
                                <span>{{ trans('label.nav_menu.book') }}</span>
                            </a>
                            <ul class="ml-menu">
                                <li>
                                    <a href="#">
                                        <i class="material-icons">add</i>
                                        <span>{{ trans('book.head.create') }}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="material-icons">list</i>
                                        <span>{{ trans('book.head.index') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle">
                                ...
                                <span>{{ trans('label.nav_menu.bookRequest') }}</span>
                            </a>
                            <ul class="ml-menu">
                                <li>
                                    <a href="#">
                                        <i class="material-icons">list</i>
                                        <span>{{ trans('bookRequest.head.index') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle">
                                ...
                                <span>{{ trans('label.nav_menu.review') }}</span>
                            </a>
                            <ul class="ml-menu">
                                <li>
                                    <a href="#">
                                        <i class="material-icons">list</i>
                                        <span>{{ trans('review.head.index') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <script src="bower/adminbsb-materialdesign/plugins/jquery-datatable/jquery.dataTables.js"></script>
